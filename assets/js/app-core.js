...
function pickSmartSession(goal,s,progress){const candidates=[]; if(goal.upcoming&&goal.upcoming[0]) candidates.push({score:100,phase:'Playbook Priority',title:goal.upcoming[0],sub:'Pulled from your next unfinished milestone so your daily session matches your actual plan.',href:'playbook.html'}); const tracks=[{pct:progress.linux,phase:'Linux',title:'Linux RHCSA push',sub:'Commands, permissions, shell, or RHCSA drills.',href:'linux.html'},{pct:progress.python,phase:'Python',title:'Python core practice',sub:'Automation momentum and AI engineering prep.',href:'python.html'},{pct:progress.ai,phase:'AI',title:'AI roadmap focus',sub:'Prompting, LLM fundamentals, retrieval, or evaluation.',href:'ai.html'},{pct:progress.claude,phase:'Claude',title:'Claude workflow session',sub:'Prompting, MCP, tool use, and Claude workflows.',href:'claude.html'},{pct:progress.cloud,phase:'Cloud',title:'Cloud networking block',sub:'Cloud foundations, AWS/Azure, or networking.',href:'cloud.html'}].sort((a,b)=>a.pct-b.pct); tracks.forEach((t,idx)=>{let score=60-idx*5; if(t.pct===0) score+=15; if(t.pct<20) score+=10; candidates.push({score:score,phase:t.phase,title:t.title,sub:t.sub,href:t.href});}); if((s.current||0)<3) candidates.push({score:88,phase:'Streak Protection',title:'Quick win to protect your streak',sub:'Take a shorter, easier session today so momentum stays alive.',href:tracks[0]?tracks[0].href:'index.html'}); return candidates.sort((a,b)=>b.score-a.score)[0]||{phase:'Focus Session',title:'Study Session',sub:'Pick one meaningful block and move it forward.',href:'index.html'};}
